...
python py2app/setup_arm64.py py2app
...
rm -rf dist/ndlite_arm64.zip
ditto -c -k --keepParent dist/ndlite.app dist/ndlite_arm64.zip


echo "submitting to apple"
xcrun notarytool submit dist/ndlite_arm64.zip  --apple-id "logand@yorku.ca"  --team-id "E76H6A445J" --password "jpgh-inpm-expa-ypfy"  --wait
